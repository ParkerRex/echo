...
class VideoProcessorService:
    ...
    def process_video(self, job: VideoJob) -> VideoJob:
        ...
        try:
            ...
            raise VideoProcessingError(f"Video processing failed: {str(e)}") from e
    ...
    def _extract_video_metadata(self, job: VideoJob, video_path: str) -> None:
        ...
        try:
            ...
            logging.info(
                f"Video metadata extracted: duration={job.video.duration}, "
                f"resolution={job.video.resolution}"
            )
    ...
    def _upload_output_files(
        ...
        try:
            ...
            raise StorageError(f"Failed to upload output files: {str(e)}") from e
