            ...
            <li key={step.id} className="relative">
              <div className={cn(
                ...
                <div className={cn(
                  ...
                  !isCompleted && !isInProgress && !isError && "border-muted-foreground/30"
                )}>
                  ...
                  {!isCompleted && !isInProgress && !isError && <span className="text-xs text-muted-foreground">{i + 1}</span>}
                </div>
                ...
                <div className="ml-4 min-w-0 flex-1">
                  <div className="flex items-center justify-between">
                    <div className={cn(
                      ...
                      !isCompleted && !isInProgress && !isError && "text-muted-foreground"
                    )}>
                      {step.label}
                    </div>
