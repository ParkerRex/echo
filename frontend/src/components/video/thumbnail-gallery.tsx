...
import { Sparkles, Check, RefreshCw, Edit2, Image, Loader2 } from "lucide-react";
          ...
          <TabsContent value="gallery" className="space-y-4">
            ...
            {selectedThumbnail && (
              <div className="space-y-2">
                <Label className="text-xs text-muted-foreground">Selected Thumbnail</Label>
              ...
              {thumbnails.map((thumbnail) => (
                <div 
                  ...
                  className={cn(
                    ...
                    thumbnail.isSelected ? "border-primary" : "border-transparent"
                  )}
                >
                  {/* Thumbnail Image */}
                ...
                {customUploadFile && (
                  <div className="mt-2 w-full max-w-xs">
                    <p className="text-xs text-muted-foreground truncate">
                      {customUploadFile.name} ({Math.round(customUploadFile.size / 1024)} KB)
                    </p>
                    <Button 
