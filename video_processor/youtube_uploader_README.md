...
4. Download the JSON file and save it as `docs/client_secret.json`
...
python -m video_processor.setup_youtube_secrets --client-secrets-file docs/client_secret.json --refresh-token YOUR_REFRESH_TOKEN
