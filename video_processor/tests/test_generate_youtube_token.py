    ...
    with patch("os.path.exists", return_value=False):
        with patch("builtins.print") as mock_print:
            ...
            mock_print.assert_any_call(
                f"Error: Client secrets file not found at '{generate_youtube_token.CLIENT_SECRETS_FILE}'"
            )
            ...
            with patch("builtins.input", return_value="test-code"):
                with patch("builtins.print") as mock_print:
                    ...
                    with patch.object(
                        ...
                        mock_print.assert_any_call(
                            f"Obtained Refresh Token: test-refresh-token"
                        )
            ...
            with patch("builtins.input", return_value="test-code"):
                with patch("builtins.print"):
                    with patch(
                        ...
                        # Enable auto-saving to Secret Manager
                        with patch.object(
                            generate_youtube_token, "SAVE_TO_SECRET_MANAGER", True
                        ):
                            # Call the function
                            generate_youtube_token.main()
                            ...
                            mock_save.assert_called_once_with(
                                ...
                                generate_youtube_token.SECRET_ID_TO_SAVE,
                                "test-refresh-token",
                            )
