    ...
    <div className="container mx-auto p-4 sm:p-6 md:p-8 max-w-3xl text-center">
      <header className="mb-12">
        ...
        <p className="text-lg sm:text-xl text-gray-600">
          Transform your raw video content into polished, engaging material with
          automated transcripts, summaries, chapters, and more. Perfect for
          creators and businesses looking to maximize their video impact.
        </p>
      </header>
        ...
        <div className="grid md:grid-cols-3 gap-6 text-left">
          <div className="p-6 bg-white rounded-lg shadow-md">
            ...
            <p className="text-gray-600">
              Simply upload your video file. We handle the rest, kicking off our
              powerful AI processing pipeline.
            </p>
          </div>
          <div className="p-6 bg-white rounded-lg shadow-md">
            <h3 className="text-xl font-semibold mb-2 text-blue-600">
            ...
            <p className="text-gray-600">
              Our AI gets to work generating accurate transcripts, insightful
              summaries, logical chapters, and even potential titles for your
              content.
            </p>
          </div>
          <div className="p-6 bg-white rounded-lg shadow-md">
            ...
            <p className="text-gray-600">
              Review the generated content, make any tweaks, and get ready to
              share your enhanced video with the world or use the assets in your
              workflow.
            </p>
          </div>
        </div>
      ...
      {isLoading ? (
        ...
        <div className="my-8 p-6 bg-blue-50 rounded-lg shadow">
          ...
          <p className="text-gray-700 mb-6">
            Sign in with Google to start processing your videos and unlock
