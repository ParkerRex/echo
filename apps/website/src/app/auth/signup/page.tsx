...
import { Card, CardContent, CardDescription, CardFooter, CardHeader, CardTitle } from '@echo/ui/card'
        ...
        <Card className="w-full max-w-md">
          ...
          <CardContent>
            <p className="text-center text-sm text-muted-foreground mb-4">
              Click the link in your email to activate your account and start optimizing your videos.
            </p>
            <div className="bg-green-50 border border-green-200 rounded-lg p-4 text-center">
              <p className="text-sm text-green-700 font-medium">
                Your free trial is ready to begin!
              </p>
            </div>
          </CardContent>
          <CardFooter>
    ...
    <div className="min-h-screen flex items-center justify-center bg-background px-4">
      <Card className="w-full max-w-md">
        <CardHeader className="space-y-1 text-center">
          ...
          <CardDescription>
            Join 2,400+ creators getting 10x better results with AI
          </CardDescription>
        </CardHeader>
        <CardContent>
