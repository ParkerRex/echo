...
from video_processor.services.storage import LocalStorageService, GCSStorageService
...
class TestLocalStorageService:
    ...
    def test_upload_from_string(self):
        ...
        with tempfile.TemporaryDirectory() as tmp_dir:
            ...
            result = service.upload_from_string("test-bucket", "Test content", "test_file.txt")
...
class TestGCSStorageService:
    ...
    def test_init(self, mock_storage_client):
        ...
        with patch("video_processor.services.storage.gcs.storage.Client") as mock_client_class:
    ...
    def test_move_file(self, mock_storage_client):
        ...
        mock_blob.exists.assert_called_once()
        mock_bucket.copy_blob.assert_called_once_with(mock_blob, mock_bucket, "destination.txt")
        mock_blob.delete.assert_called_once()


def test_get_storage_service_testing_mode():
    """Test get_storage_service in testing mode."""
    with patch("video_processor.services.storage.factory.get_settings") as mock_get_settings:
        ...
        with patch("video_processor.services.storage.factory.GCSStorageService", 
                   return_value=MagicMock(spec=GCSStorageService)) as mock_gcs:
